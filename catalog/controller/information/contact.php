	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if(isset($this->request->post['subject']) && $this->request->post['subject'] != "") {
				$mail->setSubject($this->request->post['subject']." - ".$this->request->post['name']);
			} else {
			...
			if(isset($this->request->post['name']) && $this->request->post['name'] != "") {
				$email_template .= "<strong>Name:</strong> ".$this->request->post['name']."<br />";
			}
			if(isset($this->request->post['email']) && $this->request->post['email'] != "") {
				$email_template .= "<strong>Email Address:</strong> ".$this->request->post['email']."<br />";
			}
			if(isset($this->request->post['phone']) && $this->request->post['phone'] != "") {
				$email_template .= "<strong>Phone:</strong> ".$this->request->post['phone']."<br />";
			}
			
			if(isset($this->request->post['subject']) && $this->request->post['subject'] != "") {
				$email_template .= "<strong>Subject:</strong> ".$this->request->post['subject']."<br />";
			}			
			if(isset($this->request->post['enquiry']) && $this->request->post['enquiry'] != "") {
				$email_template .= "<strong>Comments:</strong> ".$this->request->post['enquiry']."<br />";
			}
		...
		$data['text_cemail'] = $this->language->get('text_cemail');
...
$data['text_pinterest'] = $this->language->get('text_pinterest');
		...
		$data['cemail_additional'] = $this->config->get('config_email_additional');
		$data['open'] = nl2br($this->config->get('config_open'));
		$data['contact_text'] = nl2br($this->config->get('config_contact_text'));
		...
		$data['showmap'] = $this->config->get('config_map');
