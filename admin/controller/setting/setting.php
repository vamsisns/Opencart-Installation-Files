...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_email_additional'] = $this->language->get('entry_email_additional');
		$data['entry_telephone_additional'] = $this->language->get('entry_telephone_additional');
		...
		if (isset($this->request->post['config_email_additional'])) {
			$data['config_email_additional'] = $this->request->post['config_email_additional'];
		} else {
			$data['config_email_additional'] = $this->config->get('config_email_additional');
		}
		...
		if (isset($this->request->post['config_contact_text'])) {
			...
			$data['config_contact_text'] = $this->config->get('config_contact_text');
		}
