        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <?php if ($config_map) { ?>
                      <input type="radio" name="config_map" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_map" value="1" />
                      <?php echo $text_yes; ?>
                      <?php } ?>
                    </label>
                    <label class="radio-inline">
                      <?php if (!$config_map) { ?>
                      <input type="radio" name="config_map" value="0" checked="checked" />
                      <?php echo $text_no; ?>
                      <?php } else { ?>
                      <input type="radio" name="config_map" value="0" />
                      <?php echo $text_no; ?>
                      <?php } ?>
                    </label>
                  </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-email"><?php echo $entry_email_additional; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_email_additional" value="<?php echo $config_email_additional; ?>" placeholder="<?php echo $entry_email_additional; ?>" id="input-email-additional" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone_additional; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_telephone_additional" value="<?php echo $config_telephone_additional; ?>" placeholder="<?php echo $entry_telephone_additional; ?>" id="input-telephone-additional" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-contact-text"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_contact_text; ?>"><?php echo $entry_contact_text; ?></span></label>
                <div class="col-sm-10">
                <textarea name="config_contact_text" placeholder="<?php echo $entry_contact_text; ?>" id="input-contact-text" class="form-control summernote"><?php echo $config_contact_text; ?></textarea>
                 </div>
                  </div>
               <!-- Social Icons  -->
                            <div class="form-group">
                 <h3 style="text-align: center;margin: 10px 0 20px;font-weight: bold;">Social Media</h3>
                ...
                <div class="col-sm-10">
                 ...
                 <div class="social-div">
                                <label class="col-sm-2 control-label" for="input-linkedin"><?php echo $entry_linkedin; ?></label>
                <div class="col-sm-10">
